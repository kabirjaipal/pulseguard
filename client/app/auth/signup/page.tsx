      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="glass-panel p-8 rounded-2xl shadow-xl border border-card-border bg-white">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <label htmlFor="confirmPassword" className="block text-xs font-medium uppercase tracking-wider text-slate-500 mb-2">
                Confirm Password
              </label>
              <input
                id="confirmPassword"
          ...
          <div className="mt-8 pt-6 border-t border-slate-100 text-center">
            ...
            <Link href="/auth/login" className="text-primary hover:text-primary-hover text-sm font-medium transition-colors">
              Sign In
            </Link>
          </div>
        </div>
